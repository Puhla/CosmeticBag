...
import hw.cosmeticBag.CosmeticBag;


import java.util.Arrays;
import java.util.Iterator;

public class CosmeticBagImpl <E> implements CosmeticBag {
    ...
    public CosmeticBagImpl(int initialCapacity){
    ...
    private void checkIndex(int index) {
        if (index < 0 || index >= size){ //смотрим, что здесь нужно проверить
